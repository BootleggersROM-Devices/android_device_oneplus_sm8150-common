...
import com.bootleggers.device.DeviceSettings.FileUtils;
import com.bootleggers.device.DeviceSettings.Constants;
import com.bootleggers.device.DeviceSettings.R;
import com.bootleggers.device.DeviceSettings.SuShell;
import com.bootleggers.device.DeviceSettings.SuTask;
...
public class DeviceSettings extends PreferenceFragment
    ...
    public boolean onPreferenceChange(Preference preference, Object newValue) {
        if (preference == mFpsInfo) {
            ...
            Intent fpsinfo = new Intent(this.getContext(), com.bootleggers.device.DeviceSettings.FPSInfoService.class);
            if (enabled) {
